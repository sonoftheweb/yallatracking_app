...
class ZonesController extends Controller {
	...
	public function getIndex()
	{
		...
		return view('zones.index',$this->data);
	}	
	...
	{ 
		...
		return view('zones.table',$this->data);
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] 		= $this->model->getColumnTable('tb_zones'); 
		}
		$this->data['setting'] 		= $this->info['setting'];
		...
		return view('zones.form',$this->data);
	}	
	...
	public function getShow( $id = null)
	{
		...
		$this->data['setting'] 		= $this->info['setting'];
		$this->data['fields'] 		= \AjaxHelpers::fieldLang($this->info['config']['forms']);
		return view('zones.view',$this->data);	
	}	
	...
	function postCopy( Request $request)
	{
	    ...
	    foreach(\DB::select("SHOW COLUMNS FROM tb_zones ") as $column)
        {
			if( $column->Field != 'id')
		...
		$sql = "INSERT INTO tb_zones (".implode(",", $columns).") ";
		$sql .= " SELECT ".implode(",", $columns)." FROM tb_zones WHERE id IN (".$toCopy.")";
		\DB::insert($sql);
