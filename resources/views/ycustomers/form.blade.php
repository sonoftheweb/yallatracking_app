...
@section('content')
                ...
                <div class="sbox-content">
                    ...
                    <div class="col-md-4">
                        <fieldset><legend> Account Details</legend>
                            ...
                            <?php if(SiteHelpers::is_customer()){
                    ...
                    <div class="col-md-4" id="user-company-details">
                        <fieldset><legend id="ud"> User Details</legend>

                            <div class="form-group  " >
                                <label for="ipt" class=" control-label " id="fn">
                            ...
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label " id="ln">
                            ...
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label " id="ra">
                    ...
                    <div class="col-md-4" id="company-details">
                        <fieldset><legend> Company Details</legend>
                            ...
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label ">
                                    {!! SiteHelpers::activeLang('Company Name', (isset($fields['company']['language'])? $fields['company']['language'] : array())) !!}
                                </label>
                                {!! Form::text('company', $row['company'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                            </div>
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label ">
                                    {!! SiteHelpers::activeLang('Company RC Number', (isset($fields['customer_company_rc_number']['language'])? $fields['customer_company_rc_number']['language'] : array())) !!}
                                </label>
                                {!! Form::text('customer_company_rc_number', $row['customer_company_rc_number'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                            </div>
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label ">
                                    {!! SiteHelpers::activeLang('Company Director Name', (isset($fields['customer_company_director_name']['language'])? $fields['customer_company_director_name']['language'] : array())) !!}
                                </label>
                                {!! Form::text('customer_company_director_name', $row['customer_company_director_name'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                            </div>
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label ">
                                    {!! SiteHelpers::activeLang('Company Director Name 2', (isset($fields['customer_company_director_name_2']['language'])? $fields['customer_company_director_name_2']['language'] : array())) !!}
                                </label>
                                {!! Form::text('customer_company_director_name_2', $row['customer_company_director_name_2'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                            </div>
                            <div class="form-group  " >
                                <label for="ipt" class=" control-label ">
                                    {!! SiteHelpers::activeLang('Company Opening Hours', (isset($fields['customer_company_opening_hours']['language'])? $fields['customer_company_opening_hours']['language'] : array())) !!}
                                </label>
                                {!! Form::text('customer_company_opening_hours', $row['customer_company_opening_hours'],array('class'=>'form-control', 'placeholder'=>'',   )) !!}
                            </div>
                            <div class="form-group  " id="prpt" >
                                <label for="ipt" class=" control-label ">
                                    {!! SiteHelpers::activeLang('Preferred Pickup Time', (isset($fields['customer_preferred_pickup_times']['language'])? $fields['customer_preferred_pickup_times']['language'] : array())) !!}
                                    <a href="#" data-toggle="tooltip" placement="left" class="tips" title="HH:MM"><i class="icon-question2"></i></a> </label>
                                {!! Form::text('customer_preferred_pickup_times', $row['customer_preferred_pickup_times'],array('class'=>'form-control', 'placeholder'=>''  )) !!}
                            </div> </fieldset>
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            if($("#customer_group").val() === '1'){
                $("#company-details").show();
                $("#prpt").show();
                $("#ud").html("Company Details");
                $("#fn").html("Authorized Rep. First Name <span class=\"asterix\"> * </span>");
                $("#ln").html("Authorized Rep. Last Name <span class=\"asterix\"> * </span>");
                $("#ra").html("Registered Address <span class=\"asterix\"> * </span>");
            }else {
                $("#ud").html("User Details");
                $("#fn").html("First Name <span class=\"asterix\"> * </span>");
                $("#ln").html("Last Name <span class=\"asterix\"> * </span>");
                $("#ra").html("Address <span class=\"asterix\"> * </span>");
