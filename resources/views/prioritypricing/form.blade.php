...
@endif	
			{!! Form::open(array('url'=>'prioritypricing/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'prioritypricingFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Priority Based Pricing</legend>
								  ...
								  <div class="form-group  " > 
									<label for="Service Type" class=" control-label col-md-4 text-left"> 
									{!! SiteHelpers::activeLang('Service Type', (isset($fields['service_type']['language'])? $fields['service_type']['language'] : array())) !!}	
									</label>
									<div class="col-md-6">
									  {!! Form::text('service_type', $row['service_type'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " > 
									<label for="Percentage Increase In Base Price And Weight Premium" class=" control-label col-md-4 text-left"> 
									...
									<div class="col-md-6">
									  {!! Form::text('percentage_increase_in_base_price_and_weight_premium', $row['percentage_increase_in_base_price_and_weight_premium'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
...
$(document).ready(function() { 
	...
	var form = $('#prioritypricingFormAjax'); 
	form.parsley();
