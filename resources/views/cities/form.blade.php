...
@endif	
			{!! Form::open(array('url'=>'cities/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'citiesFormAjax')) !!}
			<div class="col-md-12">
						<fieldset><legend> Cities</legend>
								  ...
								  <div class="form-group  " > 
									<label for="City Code" class=" control-label col-md-4 text-left"> 
									{!! SiteHelpers::activeLang('City Code', (isset($fields['city_code']['language'])? $fields['city_code']['language'] : array())) !!}	
									</label>
									<div class="col-md-6">
									  {!! Form::text('city_code', $row['city_code'],array('class'=>'form-control', 'placeholder'=>'',   )) !!} 
									 </div> 
									 <div class="col-md-2">
								  ...
								  <div class="form-group  " > 
									<label for="City State" class=" control-label col-md-4 text-left"> 
									{!! SiteHelpers::activeLang('City State', (isset($fields['city_state']['language'])? $fields['city_state']['language'] : array())) !!}	
									</label>
									<div class="col-md-6">
									  <select name='city_state' rows='5' id='city_state' class='select2 '   ></select> 
									 </div> 
									 <div class="col-md-2">
