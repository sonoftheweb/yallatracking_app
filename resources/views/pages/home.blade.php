    ...
    <div class="container clearfix">
        <div class="row">
            ...
            <div class="col-md-3 text-right">
                <a style="margin-top: 30px;" class="btn btn-lg btn-success center" href="#">Check our Services</a>
            </div>
...
<div class="container features  clearfix">
	<div class="row">

        <div class="col-md-4">
            <div class="feature-box">
                <div class="box-media">
                    <img alt="Why choose Us?" src="{{ asset('sximo/themes/elliot/images/blank.jpg')}}"  class="img-responsive">
                </div>
                <div class="box-desc">
